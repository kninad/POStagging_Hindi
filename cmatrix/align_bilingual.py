...
CURR_DIR = ROOT_DIR + 'code/cmatrix/'
DATA_DIR = CURR_DIR + 'govt_data/'
...
def generate_count_matrix():
    ...
    word_align = CURR_DIR + "forward.align"
...
fname = CURR_DIR + txtname
text_file = open(fname, 'r')
lines = text_file.readlines()


#~ txtname = 'clean_hin_sports_set1.txt.pkl'
